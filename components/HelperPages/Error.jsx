...
const Error = (props) => {
  console.log(props.errcode, props.errmessage);
  return (
    <div>
      ...
      <div className={styles["container"]}>
        <div className={styles["left-section"]}>
          <div className={styles["inner-content"]}>
            <h1 className={styles["heading"]}>{props.errcode}</h1>
            <p className={styles["subheading"]}>{props.errmessage}</p>
          </div>
        </div>
        <div className={styles["right-section"]}>
          ...
          S149.306,67.362,149.306,71.528z"
              ...
              <circle
                className={styles["lamp-light__glow"]}
                fill="url(#SVGID_1_)"
                cx="119.676"
                cy="44.22"
                r="65"
